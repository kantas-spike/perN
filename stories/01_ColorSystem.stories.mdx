...
<div className="border-2 rounded-md m-4 p-4">
  <div className="flex gap-4 h-32 justify-stretch">
    <div className="border flex bg-tones-E_40 text-white font-bold items-center justify-center grow">
      <div>E-40</div>
    </div>
    <div className="border flex bg-tones-E_100 text-black font-bold items-center justify-center grow">
      <div>E-100</div>
    </div>
    <div className="border flex bg-tones-E_90 text-black font-bold items-center justify-center grow">
      <div>E-90</div>
    </div>
    <div className="border flex bg-tones-E_10 text-white font-bold items-center justify-center grow">
      <div>E-10</div>
    </div>
  </div>
</div>
